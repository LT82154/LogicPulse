"""
Flowers & Chocolate by Sogha Scraper - Cloudflare R2 Version (Concurrent Subcategory Scraping)
Scrapes https://www.sheeel.com/ar/flowers-chocolate-by-sogha.html and all subcategories
...
class FlowersChocolateBySoghaScraper:
    def __init__(self, r2_bucket=None, cf_access_key=None, cf_secret_key=None, cf_endpoint_url=None, max_concurrent_subcategories=3):
        self.base_url = "https://www.sheeel.com/ar/flowers-chocolate-by-sogha.html"
        self.category = "flowers_chocolate_by_sogha"
    ...
    async def get_subcategories(self, page):
        ...
        try:
            ...
            for elem in subcategory_elements:
                ...
                if url and name and '/ar/flowers-chocolate-by-sogha/' in url:
    ...
    async def scrape_product_detail(self, context, product_url, index):
        ...
        try:
            ...
            if sku_el:
                ...
                product_data['sku'] = sku_text.split(':')[1].strip()
            else:
    ...
    async def scrape_all_subcategories(self):
        ...
        print("\n" + "="*70)
        print("🚀 FLOWERS & CHOCOLATE BY SOGHA SCRAPER - CONCURRENT SUBCATEGORIES")
        print("="*70)
    ...
    def download_image(self, image_url, product_id, image_index=0, upload_immediately=True):
        """Download product image and optionally upload to Cloudflare R2 immediately"""
    ...
    def download_all_images(self):
        """Download all product images and upload to Cloudflare R2 incrementally"""
    ...
    def save_to_excel(self, include_r2_paths=False):
        ...
        filename = f"flowers_chocolate_by_sogha_{timestamp}.xlsx"
    ...
    def upload_results_to_r2(self):
        """Upload Excel to Cloudflare R2 (images already uploaded incrementally)"""
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("🌸 FLOWERS & CHOCOLATE BY SOGHA SCRAPER - CLOUDFLARE R2 (CONCURRENT)")
        print("="*70)
...
if __name__ == "__main__":
    ...
    scraper = FlowersChocolateBySoghaScraper(
        r2_bucket=r2_bucket,
