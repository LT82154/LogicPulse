"""
Coupons Scraper - Cloudflare R2 Version (Concurrent Subcategory Scraping)
Scrapes https://www.sheeel.com/ar/coupons.html and all subcategories
...
class CouponsScraper:
    def __init__(self, r2_bucket=None, cf_access_key=None, cf_secret_key=None, cf_endpoint_url=None, max_concurrent_subcategories=3):
        self.base_url = "https://www.sheeel.com/ar/coupons.html"
    ...
    async def get_subcategories(self, page):
        ...
        try:
            ...
            for elem in subcategory_elements:
                ...
                if url and name and '/ar/coupons/' in url:
    ...
    async def scrape_all_subcategories(self):
        ...
        print("\n" + "="*70)
        print("🚀 COUPONS SCRAPER - CONCURRENT SUBCATEGORIES")
        print("="*70)
    ...
    def upload_results_to_r2(self):
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"coupons_{timestamp}.xlsx"
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("🎫 COUPONS SCRAPER - CLOUDFLARE R2 (CONCURRENT)")
        print("="*70)
